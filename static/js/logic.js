// Create URL for earthquake and tectonic plate layers
...
function createMap(earthquakes) {
    ...
    // Create the map and default settings
    var myMap = L.map("map", {
        center: [38, -104],
        zoom: 4,
...
// Assign color scheme to data markers and legend
...
// Create radius size of earthquake
